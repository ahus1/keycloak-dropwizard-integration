...
# Simple Dropwizard Integration

## What you can see here

This is a very simple Dropwizard application setup to use Freemarker as templating.
...
----
mvn test -pl keycloak-dropwizard-jetty -am -Peycloak-dropwizard-jetty
----
