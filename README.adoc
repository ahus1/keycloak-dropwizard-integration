...
image:https://img.shields.io/maven-central/v/de.ahus1.keycloak.dropwizard/keycloak-dropwizard-parent[Maven Central]
  ...
  * Version 1.1.x is tested with Keycloak 4.x-10.x and Dropwizard 1.3.x/2.0.x
